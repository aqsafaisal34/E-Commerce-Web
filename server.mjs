...
app.put("/product/:id", (req, res) => {
    ...
    productModel.findByIdAndUpdate(id, function (err, result) {
        if (err) {
            console.log(err)
            res.send({
                message : "error in db"
...
let dbURI = 'mongodb+srv://abc:abc@cluster0.iunhwh0.mongodb.net/ECommerceDatabase?retryWrites=true&w=majority';
